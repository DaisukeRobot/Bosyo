...
/**
 * @title Abstract contracts that implement templates for some methods
 * @author Takashi
 * @notice Account contracts inherit and implement the specific logic of methods in this contract
 */
abstract contract BaseAccount is IAccount {
    ...
    /**
     * @return return the entryPoint used by this account.
